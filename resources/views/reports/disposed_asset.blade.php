<table>
    <thead>
        <tr>
            <th colspan="14">
                <div style="display: inline">
                    ...
                    <div>
                        <h1 style="font-size: 20px; font-weight: 900">Disposed Asset Report</h1>
                    </div>
                </div>
            </th>
        </tr>
        <tr class="blue darken-2">
            ...
            <th style="background-color: #0072ce; color: white; text-align: center; width: 120px"><b>Disposed Date</b>
            </th>
            <th style="background-color: #0072ce; color: white; text-align: center; width: 120px"><b>Transfer To</b>
            </th>
            <th style="background-color: #0072ce; color: white; text-align: center; width: 120px"><b>Accumulated
                    Depreciation</b></th>
            <th style="background-color: #0072ce; color: white; text-align: center; width: 120px"><b>Replacement
                    Cost</b></th>
            <th style="background-color: #0072ce; color: white; text-align: center; width: 120px"><b>Disposal Type</b>
            </th>
            <th style="background-color: #0072ce; color: white; text-align: center; width: 120px"><b>Disposal Reason</b>
            </th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align: center">{{ $asset->assetDisposal->date ?? "" }}</td>
            <td style="text-align: center">{{ $asset->assetDisposal->transfer_to ?? "" }}</td>
            <td style="text-align: center">{{ $asset->assetDisposal->accumulated_depreciation ?? "" }}</td>
            <td style="text-align: center">{{ $asset->assetDisposal->replacement_cost ?? "" }}
                <small>{{ $asset->assetDisposal->currency->code }}</small>
            </td>
            <td style="text-align: center">{{ $asset->assetDisposal->disposalType->name ?? "" }}</td>
            <td style="text-align: center">{{ $asset->assetDisposal->disposalReason->name ?? "" }}</td>
            <td style="text-align: center">{{ $asset->assetDisposal->remark ?? "" }}</td>
